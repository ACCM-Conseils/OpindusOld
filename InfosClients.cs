...
namespace Opindus
{
	...
	/// </summary>
	public class InfosClients : System.Windows.Forms.Form
	{
		...
		public InfosClients(int Agence)
		{
			//
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(InfosClients));
		...
		private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
		{
			...
			e.Graphics.DrawString("Nom société", new Font("Arial", 8, FontStyle.Bold), Brushes.Red, e.MarginBounds.Left, e.MarginBounds.Top+5);
			e.Graphics.DrawString("Adresse", new Font("Arial", 8, FontStyle.Bold), Brushes.Blue, e.MarginBounds.Left, e.MarginBounds.Top+20);
			e.Graphics.DrawString("Règlement", new Font("Arial", 8, FontStyle.Bold), Brushes.Red, e.MarginBounds.Left, e.MarginBounds.Top+35);
			e.Graphics.DrawString("Port", new Font("Arial", 8, FontStyle.Bold), Brushes.Red, e.MarginBounds.Left+130, e.MarginBounds.Top+35);
			e.Graphics.DrawString("Seuil Rep.", new Font("Arial", 8, FontStyle.Bold), Brushes.Red, e.MarginBounds.Left+245, e.MarginBounds.Top+35);
			e.Graphics.DrawString("Délai garant.", new Font("Arial", 8, FontStyle.Bold), Brushes.Red, e.MarginBounds.Left+325, e.MarginBounds.Top+35);
			e.Graphics.DrawString("Coef DNR", new Font("Arial", 8, FontStyle.Bold), Brushes.Red, e.MarginBounds.Left+405, e.MarginBounds.Top+35);
			e.Graphics.DrawString("Forfait DNR", new Font("Arial", 8, FontStyle.Bold), Brushes.Red, e.MarginBounds.Left+485, e.MarginBounds.Top+35);
			e.Graphics.DrawString("Coef Cont.", new Font("Arial", 8, FontStyle.Bold), Brushes.Red, e.MarginBounds.Left+565, e.MarginBounds.Top+35);
			e.Graphics.DrawString("Forf Cont.", new Font("Arial", 8, FontStyle.Bold), Brushes.Red, e.MarginBounds.Left+645, e.MarginBounds.Top+35);
			e.Graphics.DrawString("Coef. Trans", new Font("Arial", 8, FontStyle.Bold), Brushes.Red, e.MarginBounds.Left+725, e.MarginBounds.Top+35);
			e.Graphics.DrawString("Forf. Trans", new Font("Arial", 8, FontStyle.Bold), Brushes.Red, e.MarginBounds.Left+805, e.MarginBounds.Top+35);
			e.Graphics.DrawString("% Remise", new Font("Arial", 8, FontStyle.Bold), Brushes.Red, e.MarginBounds.Left+905, e.MarginBounds.Top+35);
			ypos+=5;
			while(ypos<e.MarginBounds.Height&&countRow<dataSet11.Tables["t_clients"].Rows.Count)
			{
				...
				e.Graphics.DrawLine(new Pen(Color.Blue, 1),new Point(e.MarginBounds.Left,ypos-1), new Point(e.MarginBounds.Left,ypos+57));
				e.Graphics.DrawLine(new Pen(Color.Blue, 1),new Point(e.MarginBounds.Right,ypos-1), new Point(e.MarginBounds.Right,ypos+57));
				ypos+=5;
				e.Graphics.DrawString(dataSet11.Tables["t_clients"].Rows[countRow]["Nom"].ToString(), 
					new Font("Arial", 8, FontStyle.Bold), Brushes.Red, e.MarginBounds.Left, ypos);
				ypos+=15;
				e.Graphics.DrawString(dataSet11.Tables["t_clients"].Rows[countRow]["Adresse_1"].ToString(), 
					new Font("Arial", 8, FontStyle.Bold), Brushes.Blue, e.MarginBounds.Left, ypos);
				e.Graphics.DrawString(dataSet11.Tables["t_clients"].Rows[countRow]["Code_postal"].ToString(), 
					new Font("Arial", 8, FontStyle.Bold), Brushes.Blue, e.MarginBounds.Left+400, ypos);
				e.Graphics.DrawString(dataSet11.Tables["t_clients"].Rows[countRow]["Ville"].ToString(), 
					new Font("Arial", 8, FontStyle.Bold), Brushes.Blue, e.MarginBounds.Left+450, ypos);
				e.Graphics.DrawString(dataSet11.Tables["t_clients"].Rows[countRow]["Telephone"].ToString(), 
					new Font("Arial", 8, FontStyle.Bold), Brushes.Blue, e.MarginBounds.Left+750, ypos);
				e.Graphics.DrawString(dataSet11.Tables["t_clients"].Rows[countRow]["telecopie"].ToString(), 
				...
				string traite="?";
				string port="?";
				if(dataSet11.Tables["T_clients"].Rows[countRow]["Code_reglement"].ToString().Equals("TA"))
				{
					traite="TRAITE ACCEPTEE";
				}
				if(dataSet11.Tables["T_clients"].Rows[countRow]["Code_transport"].ToString().Equals("PP"))
				{
					port="Port payé";
				}
				e.Graphics.DrawString(traite, 
					new Font("Arial", 8, FontStyle.Bold), Brushes.Red, e.MarginBounds.Left, ypos);
				e.Graphics.DrawString(port, 
					new Font("Arial", 8, FontStyle.Bold), Brushes.Red, e.MarginBounds.Left+130, ypos);
				e.Graphics.DrawString(dataSet11.Tables["T_clients"].Rows[countRow]["Seuil_reparation"].ToString()+",00%", 
					new Font("Arial", 8, FontStyle.Bold), Brushes.Red, e.MarginBounds.Left+260, ypos);
				e.Graphics.DrawString(dataSet11.Tables["T_clients"].Rows[countRow]["Delai_garantie"].ToString(), 
					new Font("Arial", 8, FontStyle.Bold), Brushes.Red, e.MarginBounds.Left+350, ypos);
				e.Graphics.DrawString(dataSet11.Tables["T_clients"].Rows[countRow]["Coef_DNR"].ToString(), 
					new Font("Arial", 8, FontStyle.Bold), Brushes.Red, e.MarginBounds.Left+430, ypos);
				e.Graphics.DrawString(dataSet11.Tables["T_clients"].Rows[countRow]["Forfait_DNR"].ToString(), 
					new Font("Arial", 8, FontStyle.Bold), Brushes.Red, e.MarginBounds.Left+510, ypos);
				e.Graphics.DrawString(dataSet11.Tables["T_clients"].Rows[countRow]["Coef_controle"].ToString(), 
					new Font("Arial", 8, FontStyle.Bold), Brushes.Red, e.MarginBounds.Left+590, ypos);
				e.Graphics.DrawString(dataSet11.Tables["T_clients"].Rows[countRow]["Forfait_controle"].ToString(), 
					new Font("Arial", 8, FontStyle.Bold), Brushes.Red, e.MarginBounds.Left+670, ypos);
				e.Graphics.DrawString(dataSet11.Tables["T_clients"].Rows[countRow]["Coef_transport"].ToString(), 
					new Font("Arial", 8, FontStyle.Bold), Brushes.Red, e.MarginBounds.Left+750, ypos);
				e.Graphics.DrawString(dataSet11.Tables["T_clients"].Rows[countRow]["Forfait_transport"].ToString(), 
					new Font("Arial", 8, FontStyle.Bold), Brushes.Red, e.MarginBounds.Left+830, ypos);
				e.Graphics.DrawString(dataSet11.Tables["T_clients"].Rows[countRow]["Pourcentage_remise"].ToString()+",00%", 
					new Font("Arial", 8, FontStyle.Bold), Brushes.Red, e.MarginBounds.Left+910, ypos);
				ypos+=15;
				e.Graphics.DrawLine(new Pen(Color.Blue, 1),new Point(e.MarginBounds.Left,ypos), new Point(e.MarginBounds.Right,ypos));
				ypos+=5;
				countRow+=1;
