...
{
	/// <summary>
	/// Description résumée de ActiviteRepGar.
	/// </summary>
	public class ActiviteRepGar : System.Windows.Forms.Form
	{
		...
		private DateTime DebutActivite;
		private DateTime FinActivite;
		private int ypos;
		private DataSet ds;
		...
		public ActiviteRepGar(int Agence)
		{
			//
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(ActiviteRepGar));
			...
			this.label1.Text = "Activité réparateurs garantie";
			...
			// oleDbConnection1
			// 
			this.oleDbConnection1.ConnectionString = @"Jet OLEDB:Global Partial Bulk Ops=2;Jet OLEDB:Registry Path=;Jet OLEDB:Database Locking Mode=1;Jet OLEDB:Database Password=;Data Source=""C:\Database\Lyon\bd.mdb"";Password=;Jet OLEDB:Engine Type=5;Jet OLEDB:Global Bulk Transactions=1;Provider=""Microsoft.Jet.OLEDB.4.0"";Jet OLEDB:System database=;Jet OLEDB:SFP=False;Extended Properties=;Mode=Share Deny None;Jet OLEDB:New Database Password=;Jet OLEDB:Create System Database=False;Jet OLEDB:Don't Copy Locale on Compact=False;Jet OLEDB:Compact Without Replica Repair=False;User ID=Admin;Jet OLEDB:Encrypt Database=False";
			// 
			// button2
			// 
			...
			this.Name = "ActiviteRepGar";
			this.ShowInTaskbar = false;
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Activite réparateurs";
		...
		{
			DebutActivite=System.Convert.ToDateTime(textBox1.Text);
			FinActivite=System.Convert.ToDateTime(textBox2.Text);
		...
		private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
		{
			...
			e.Graphics.DrawString("Activité réparateurs garanties", new Font("Arial", 20, FontStyle.Bold), Brushes.Black, e.MarginBounds.Left+160, ypos);
			ypos+=50;
			e.Graphics.DrawString("Période du "+textBox1.Text+" au "+textBox2.Text, new Font("Arial", 12, FontStyle.Bold), Brushes.Black, e.MarginBounds.Left+235, ypos);
			ypos+=50;
			e.Graphics.DrawString("Garantie", new Font("Arial", 12, FontStyle.Bold), Brushes.Black, e.MarginBounds.Left+150, ypos);
			e.Graphics.DrawString("Réparation", new Font("Arial", 12, FontStyle.Bold), Brushes.Black, e.MarginBounds.Left+430, ypos);
			ypos+=25;
			e.Graphics.DrawLine(new Pen(Color.Black, 1),new Point(e.MarginBounds.Left,ypos), new Point(e.MarginBounds.Right,ypos));
			ypos+=25;
			e.Graphics.DrawString("Code machine", new Font("Arial", 10, FontStyle.Bold), Brushes.Black, e.MarginBounds.Left, ypos);
			e.Graphics.DrawString("Devis", new Font("Arial", 10, FontStyle.Bold), Brushes.Black, e.MarginBounds.Left+150, ypos);
			e.Graphics.DrawString("Date", new Font("Arial", 10, FontStyle.Bold), Brushes.Black, e.MarginBounds.Left+230, ypos);
			e.Graphics.DrawString("OD", new Font("Arial", 10, FontStyle.Bold), Brushes.Black, e.MarginBounds.Left+320, ypos);
			e.Graphics.DrawString("OR", new Font("Arial", 10, FontStyle.Bold), Brushes.Black, e.MarginBounds.Left+380, ypos);
			e.Graphics.DrawString("Devis", new Font("Arial", 10, FontStyle.Bold), Brushes.Black, e.MarginBounds.Left+430, ypos);
			e.Graphics.DrawString("Date", new Font("Arial", 10, FontStyle.Bold), Brushes.Black, e.MarginBounds.Left+530, ypos);
			e.Graphics.DrawString("OD", new Font("Arial", 10, FontStyle.Bold), Brushes.Black, e.MarginBounds.Left+630, ypos);
			e.Graphics.DrawString("OR", new Font("Arial", 10, FontStyle.Bold), Brushes.Black, e.MarginBounds.Left+680, ypos);
			ypos+=25;
			e.Graphics.DrawLine(new Pen(Color.Black, 1),new Point(e.MarginBounds.Left,ypos), new Point(e.MarginBounds.Right,ypos));
			ypos+=25;
			...
			foreach(DataRow row in ds.Tables["t_devis_entete"].Rows)
			{
				if(row["date reparation"].ToString().Length>0)
				{
					...
					{
						e.Graphics.DrawString(row["code materiel"].ToString(), new Font("Arial", 12, FontStyle.Regular), Brushes.Black, e.MarginBounds.Left, ypos);
						e.Graphics.DrawString(row["N° Devis"].ToString(), new Font("Arial", 12, FontStyle.Regular), Brushes.Black, e.MarginBounds.Left+150, ypos);
						e.Graphics.DrawString(row["Date reparation"].ToString().Remove(10,9), new Font("Arial", 12, FontStyle.Regular), Brushes.Black, e.MarginBounds.Left+230, ypos);
						e.Graphics.DrawString(row["reparateur_d"].ToString(), new Font("Arial", 12, FontStyle.Regular), Brushes.Black, e.MarginBounds.Left+330, ypos);
						e.Graphics.DrawString(row["reparateur_r"].ToString(), new Font("Arial", 12, FontStyle.Regular), Brushes.Black, e.MarginBounds.Left+380, ypos);
						...
						DataAD.Fill(ds,"t_devis");
						if(ds.Tables["t_devis"].Rows.Count>0)
						{
							e.Graphics.DrawString(ds.Tables["t_devis"].Rows[0]["N° devis"].ToString(), new Font("Arial", 12, FontStyle.Regular), Brushes.Black, e.MarginBounds.Left+430, ypos);
							e.Graphics.DrawString(ds.Tables["t_devis"].Rows[0]["Date reparation"].ToString().Remove(10,9), new Font("Arial", 12, FontStyle.Regular), Brushes.Black, e.MarginBounds.Left+530, ypos);
							e.Graphics.DrawString(ds.Tables["t_devis"].Rows[0]["Reparateur_D"].ToString(), new Font("Arial", 12, FontStyle.Regular), Brushes.Black, e.MarginBounds.Left+630, ypos);
							e.Graphics.DrawString(ds.Tables["t_devis"].Rows[0]["Reparateur_R"].ToString(), new Font("Arial", 12, FontStyle.Regular), Brushes.Black, e.MarginBounds.Left+680, ypos);						
						}
						ds.Tables["t_devis"].Clear();
						ypos+=20;
					}
				}
			}
		...
		private void button4_Click(object sender, System.EventArgs e)
		{
			...
			String D1=DebutActivite.ToShortDateString();
			String D2=FinActivite.ToShortDateString();
			ActiviteRepGarChiffres WinRep = new ActiviteRepGarChiffres(Agence, D1, D2);
			WinRep.ShowDialog();
		}
	}
}
