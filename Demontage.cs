...
{
	/// <summary>
	/// Description résumée de Demontage.
	/// </summary>
	public class Demontage : System.Windows.Forms.Form
	{
		...
		public Demontage(int Agence)
		{
			...
			Comm.CommandText="SELECT T_devis_entete.[N° Devis], T_devis_entete.Date, T_devis_entete.[Code Materiel], T_devis_entete.Niveau, T_clients.Nom FROM T_devis_entete INNER JOIN T_clients ON T_devis_entete.[Code Client] = T_clients.Ident WHERE (((T_devis_entete.Niveau)=2)) ORDER BY T_devis_entete.[N° Devis]";
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(Demontage));
		...
		private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
		{
			...
			e.Graphics.DrawString("Attente démontage", new Font("Arial", 20, FontStyle.Bold), Brushes.Black, e.MarginBounds.Left+200, e.MarginBounds.Top);
			ypos+=5;
			e.Graphics.DrawString("N° devis", new Font("Arial", 8, FontStyle.Bold), Brushes.Blue, e.MarginBounds.Left, ypos);
			e.Graphics.DrawString("Date", new Font("Arial", 8, FontStyle.Bold), Brushes.Blue, e.MarginBounds.Left+100, ypos);
			e.Graphics.DrawString("Client", new Font("Arial", 8, FontStyle.Bold), Brushes.Blue, e.MarginBounds.Left+200, ypos);
			e.Graphics.DrawString("Code matériel", new Font("Arial", 8, FontStyle.Bold), Brushes.Blue, e.MarginBounds.Left+470, ypos);
			e.Graphics.DrawString("Niveau", new Font("Arial", 8, FontStyle.Bold), Brushes.Blue, e.MarginBounds.Left+570, ypos);
			ypos+=17;
			...
			while(ypos<e.MarginBounds.Height&&(countRow<dataSet11.Tables["t_devis_entete"].Rows.Count)&&(dataSet11.Tables["t_devis_entete"].Rows.Count>0))
			{
				...
				e.Graphics.DrawString(dataSet11.Tables["t_devis_entete"].Rows[countRow]["niveau"].ToString(), 
