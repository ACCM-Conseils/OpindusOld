...
{
	/// <summary>
	/// Description résumée de AcTransports.
	/// </summary>
	public class AcTransports : System.Windows.Forms.Form
	{
		...
		public AcTransports(int Agence)
		{
			//
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(AcTransports));
			...
			this.mtgcComboBox1.Location = new System.Drawing.Point(126, 24);
			...
			this.mtgcComboBox1.Size = new System.Drawing.Size(270, 21);
			...
			else
			{
				...
				if(Nouveau)
				{
					foreach(DataRow row in Table.Rows)
					{
						...
						{
							MessageBox.Show("Code déjà présent dans la base !","Attention",MessageBoxButtons.OK, MessageBoxIcon.Warning);
							save=false;
						}
					}
				}
				if(save)
				{
					if(Nouveau)
					{
						...
						newrow["Designation"]=txDesignation.Text;
					...
					else
					{
						...
						Comm.CommandText="update t_transport set designation ='"+txDesignation.Text+"' where code='"+txCode.Text+"'";
