...
{
	/// <summary>
	/// Description résumée de CommandesEnCours.
	/// </summary>
	public class CommandesEnCours : System.Windows.Forms.Form
	{
		...
		public CommandesEnCours(int Agence)
		{
			//
			...
			oleDbSelectCommand1.CommandText="SELECT T_CDE_entete.*, T_fournisseurs.Nom, T_CDE_entete.Solde FROM T_fournisseurs INNER JOIN T_CDE_entete ON T_fournisseurs.Code = T_CDE_entete.[Code fournisseur] WHERE (((T_CDE_entete.Solde)=False)) ORDER BY [N° commande] DESC";
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(CommandesEnCours));
			...
			this.printPreviewDialog1.Location = new System.Drawing.Point(409, 17);
		...
		private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
		{
			...
			ypos+=5;
			e.Graphics.DrawString("N° commande", new Font("Arial", 8, FontStyle.Bold), Brushes.Blue, e.MarginBounds.Left, ypos);
			e.Graphics.DrawString("Date commande", new Font("Arial", 8, FontStyle.Bold), Brushes.Blue, e.MarginBounds.Left+100, ypos);
			e.Graphics.DrawString("Fournisseur", new Font("Arial", 8, FontStyle.Bold), Brushes.Blue, e.MarginBounds.Left+350, ypos);
			e.Graphics.DrawString("Solde", new Font("Arial", 8, FontStyle.Bold), Brushes.Blue, e.MarginBounds.Left+550, ypos);
			ypos+=17;
			...
			while(ypos<e.MarginBounds.Height&&(countRow<dataSet11.Tables["t_CDE_entete"].Rows.Count)&&(dataSet11.Tables["t_CDE_entete"].Rows.Count>0))
			{
				e.Graphics.DrawString(dataSet11.Tables["t_CDE_entete"].Rows[countRow]["N° commande"].ToString(), 
					new Font("Arial", 8, FontStyle.Bold), Brushes.Black, e.MarginBounds.Left+20, ypos);
				if(dataSet11.Tables["t_CDE_entete"].Rows[countRow]["Date commande"].ToString().Length>0)
					e.Graphics.DrawString(dataSet11.Tables["t_CDE_entete"].Rows[countRow]["Date commande"].ToString().Remove(10,9), 
						new Font("Arial", 8, FontStyle.Bold), Brushes.Black, e.MarginBounds.Left+110, ypos);
				...
				e.Graphics.DrawString("Non", 
					new Font("Arial", 8, FontStyle.Bold), Brushes.Black, e.MarginBounds.Left+555, ypos);
