...
{
	/// <summary>
	/// Description résumée de Niveaux.
	/// </summary>
	public class Niveaux : System.Windows.Forms.Form
	{
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(Niveaux));
			...
			this.label1.Text = "Edition des devis par niveau";
			// 
			// groupBox1
			// 
			...
			this.groupBox1.Text = "Niveaux";
			// 
			// radioButton9
			// 
			this.radioButton9.FlatStyle = System.Windows.Forms.FlatStyle.Flat;
			this.radioButton9.Location = new System.Drawing.Point(464, 24);
			this.radioButton9.Name = "radioButton9";
			this.radioButton9.Size = new System.Drawing.Size(32, 24);
			...
			this.radioButton8.Location = new System.Drawing.Point(408, 24);
			this.radioButton8.Name = "radioButton8";
			this.radioButton8.Size = new System.Drawing.Size(32, 24);
			...
			this.radioButton7.Location = new System.Drawing.Point(352, 24);
			this.radioButton7.Name = "radioButton7";
			this.radioButton7.Size = new System.Drawing.Size(32, 24);
			...
			this.radioButton6.Location = new System.Drawing.Point(296, 24);
			this.radioButton6.Name = "radioButton6";
			this.radioButton6.Size = new System.Drawing.Size(32, 24);
			...
			this.radioButton5.Location = new System.Drawing.Point(240, 24);
			this.radioButton5.Name = "radioButton5";
			this.radioButton5.Size = new System.Drawing.Size(32, 24);
			...
			this.radioButton4.Location = new System.Drawing.Point(184, 24);
			...
			this.radioButton2.Location = new System.Drawing.Point(72, 24);
			...
			this.button5.Location = new System.Drawing.Point(464, 112);
		...
		private void button1_Click(object sender, System.EventArgs e)
		{
			...
			{
				Comm.CommandText="select t_clients.[Nom],t_devis_entete.[N° Devis], t_devis_entete.[Date],t_devis_entete.[Code materiel],t_parc_machine.[Type machine] from t_devis_entete,t_clients,t_parc_machine where t_parc_machine.[code machine opindus]=t_devis_entete.[Code materiel] and t_clients.ident=t_devis_entete.[Code client] and t_devis_entete.[Niveau]=4 order by 1,3,2";
			}
			else if(radioButton5.Checked)
			{
				Comm.CommandText="select t_clients.[Nom],t_devis_entete.[N° Devis], t_devis_entete.[Date],t_devis_entete.[Code materiel],t_parc_machine.[Type machine] from t_devis_entete,t_clients,t_parc_machine where t_parc_machine.[code machine opindus]=t_devis_entete.[Code materiel] and t_clients.ident=t_devis_entete.[Code client] and t_devis_entete.[Niveau]=5 order by 1,3,2";
			}
			else if(radioButton6.Checked)
			{
				Comm.CommandText="select t_clients.[Nom],t_devis_entete.[N° Devis], t_devis_entete.[Date],t_devis_entete.[Code materiel],t_parc_machine.[Type machine] from t_devis_entete,t_clients,t_parc_machine where t_parc_machine.[code machine opindus]=t_devis_entete.[Code materiel] and t_clients.ident=t_devis_entete.[Code client] and t_devis_entete.[Niveau]=6 order by 1,3,2";
			}
			else if(radioButton7.Checked)
			{
				Comm.CommandText="select t_clients.[Nom],t_devis_entete.[N° Devis], t_devis_entete.[Date],t_devis_entete.[Code materiel],t_parc_machine.[Type machine] from t_devis_entete,t_clients,t_parc_machine where t_parc_machine.[code machine opindus]=t_devis_entete.[Code materiel] and t_clients.ident=t_devis_entete.[Code client] and t_devis_entete.[Niveau]=7 order by 1,3,2";
			}
			else if(radioButton8.Checked)
			{
				Comm.CommandText="select t_clients.[Nom],t_devis_entete.[N° Devis], t_devis_entete.[Date],t_devis_entete.[Code materiel],t_parc_machine.[Type machine] from t_devis_entete,t_clients,t_parc_machine where t_parc_machine.[code machine opindus]=t_devis_entete.[Code materiel] and t_clients.ident=t_devis_entete.[Code client] and t_devis_entete.[Niveau]=8 order by 1,3,2";
			}
			else if(radioButton9.Checked)
			{
				Comm.CommandText="select t_clients.[Nom],t_devis_entete.[N° Devis], t_devis_entete.[Date],t_devis_entete.[Code materiel],t_parc_machine.[Type machine] from t_devis_entete,t_clients,t_parc_machine where t_parc_machine.[code machine opindus]=t_devis_entete.[Code materiel] and t_clients.ident=t_devis_entete.[Code client] and t_devis_entete.[Niveau]=9 order by 1,3,2";
			}
		...
		private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
		{
			...
			if(radioButton1.Checked)
				e.Graphics.DrawString("Niveau 1", new Font("Arial", 40, FontStyle.Bold), Brushes.Black, e.MarginBounds.Left+200, e.MarginBounds.Top);
			else if(radioButton2.Checked)
				e.Graphics.DrawString("Niveau 2", new Font("Arial", 40, FontStyle.Bold), Brushes.Black, e.MarginBounds.Left+200, e.MarginBounds.Top);
			else if(radioButton3.Checked)
				e.Graphics.DrawString("Niveau 3", new Font("Arial", 40, FontStyle.Bold), Brushes.Black, e.MarginBounds.Left+200, e.MarginBounds.Top);
			else if(radioButton4.Checked)
				e.Graphics.DrawString("Niveau 4", new Font("Arial", 40, FontStyle.Bold), Brushes.Black, e.MarginBounds.Left+200, e.MarginBounds.Top);
			else if(radioButton5.Checked)
				e.Graphics.DrawString("Niveau 5", new Font("Arial", 40, FontStyle.Bold), Brushes.Black, e.MarginBounds.Left+200, e.MarginBounds.Top);
			else if(radioButton6.Checked)
				e.Graphics.DrawString("Niveau 6", new Font("Arial", 40, FontStyle.Bold), Brushes.Black, e.MarginBounds.Left+200, e.MarginBounds.Top);
			else if(radioButton7.Checked)
				e.Graphics.DrawString("Niveau 7", new Font("Arial", 40, FontStyle.Bold), Brushes.Black, e.MarginBounds.Left+200, e.MarginBounds.Top);
			else if(radioButton8.Checked)
				e.Graphics.DrawString("Niveau 8", new Font("Arial", 40, FontStyle.Bold), Brushes.Black, e.MarginBounds.Left+200, e.MarginBounds.Top);
			else if(radioButton9.Checked)
				e.Graphics.DrawString("Niveau 9", new Font("Arial", 40, FontStyle.Bold), Brushes.Black, e.MarginBounds.Left+200, e.MarginBounds.Top);
			ypos+=5;
			...
			while(ypos<e.MarginBounds.Height&&(countRow<dataSet11.Tables["t_devis_entete"].Rows.Count)&&(dataSet11.Tables["t_devis_entete"].Rows.Count>0))
			{
				...
				if(ancienfourn!=dataSet11.Tables["t_devis_entete"].Rows[countRow]["Nom"].ToString())
				{
					ypos+=10;
